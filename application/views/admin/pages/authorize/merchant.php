            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Tables Merchant</h3>
                  <div class="box-body clearfix">
                      <blockquote class="pull-left">
                          <small>
                          <cite title="Source Title">
                              Modul yang berfungsi untuk approval user yang sudah melakukan registrasi menjadi user merchant. </cite>
                          </small>
                      </blockquote>
                  </div>
                </div>
                    ...
                    <tbody>
                      ...
                      foreach ($customerList as $key => $value) {
                          ...
                          echo "<td class='text-center'>
                                  <form id='cust".$value['ID']."' method='POST' action=".base_url()."authorize/merchant_detail>
                                  <input type='hidden' name='custId' value='".$value['ID']."'>
                                  <a onclick='prosesFormMerchant(".$value['ID'].")' style='cursor: pointer;'><i class='fa fa fa-edit' title='open'></i></a></form>
                                </td>";
                          echo "</tr>";
                      }?>
                    </tbody>
