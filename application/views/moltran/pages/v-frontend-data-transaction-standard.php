                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form">
                                            ...
                                            <form class="cmxform form-horizontal tasi-form" id="dataTransaction" method="post" action="<?php echo @ site_url('frontend/reporting/transaction-record'); ?>">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-10">
			                                            <select required="required" name="keytype" class="select2 form-control" data-placeholder="-- Pilih Field Pencarian --">
			                                              	<option value="">&nbsp;</option>
			                                              	<option value="SYSLOGNO">ID Transaksi</option>
			                                              	<option value="REFNO">Nomor Referensi</option>
			                                              	<option value="TRXCODE">Tipe Transaksi</option>
			                                              	<option value="CUSTCODE">ID T-MONEY</option>
			                                              	<option value="TRXVALUE">Nominal</option>
			                                              	<option value="TRFCHARGES">Fee</option>
			                                              	<option value="LASTSTATE">Tahapan</option>
			                                              	<option value="LASTRC">RC Fusion</option>
			                                              	<option value="LASTRCFIN">RC Finnet</option>
			                                              	<option value="RCVTIME">Waktu</option>
			                                              	<option value="MERCHCODE">Kode Merchant</option>
			                                              	<option value="SUBMERCH">Kode Sub Merchant</option>
			                                              	<option value="PRODCODE">Kode Produk</option>
			                                              	<option value="INVOICENO">Nomor Invoice</option>
			                                              	<option value="INVOICENAME">Nama Invoice</option>
			                                              	<!-- <option value="DSAC">Akun Tujuan</option> -->
			                                            </select>
                                                    </div>
                                                </div>
                                            	<div class="form-group">
