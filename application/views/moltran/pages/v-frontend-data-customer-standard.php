                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form">
                                            ...
                                            <form class="cmxform form-horizontal tasi-form" id="dataCustomer" method="post" action="<?php echo @ site_url('frontend/reporting/customer-record'); ?>">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-10">
			                                            <select required="required" name="keytype" class="select2 form-control" data-placeholder="-- Pilih Field Pencarian --">
			                                              	...
			                                              	<option value="CUSTNAME">Nama Lengkap</option>
			                                              	<option value="EMAIL">Alamat Email</option>
			                                              	<!-- <option value="CUSTTYPEID">Tipe Akun</option> -->
			                                              	<option value="ACTIVATIONCODE">Kode Aktivasi</option>
			                                            </select>
                                                    </div>
                                                </div>
                                            	<div class="form-group">
